...
private fun ItemDetailsBody(
    ...
    Column(
        ...
        OutlinedButton(
            onClick = {
                val item_data: String = "Name: " + itemDetailsUiState.itemDetails.name + "\n" +
                ...
                val sendIntent: Intent = Intent().apply {
                    ...
                    putExtra(Intent.EXTRA_TEXT, item_data)
                    type = "text/plain"
                }
    ...
    Card(
        ...
        Column(
            ...
            ItemDetailsRow(
                ...
                itemDetail = item.suppliers_name,
                modifier = Modifier.padding(
                    horizontal = dimensionResource(id = R.dimen.padding_medium)
                )
            )
            ItemDetailsRow(
                ...
                itemDetail = item.suppliers_email,
                modifier = Modifier.padding(
                    horizontal = dimensionResource(id = R.dimen.padding_medium)
                )
            )
            ItemDetailsRow(
                ...
                itemDetail = item.suppliers_mobile_phone,
                modifier = Modifier.padding(
                    horizontal = dimensionResource(id = R.dimen.padding_medium)
                )
            )
...
fun ItemDetailsScreenPreview() {
    InventoryTheme {
        ItemDetailsBody(
            ItemDetailsUiState(
                outOfStock = true,
                itemDetails = ItemDetails(1, "Pen", "$100", "10", "Maxim", "maxim@mail.ru", "89561763092")
            ),
            onSellItem = {},
            onDelete = {}
        )
